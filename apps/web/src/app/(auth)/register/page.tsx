        ...
        <div className="min-h-screen flex items-center justify-center px-4 py-12">
            <div className="w-full max-w-[520px]">
                ...
                <div className="flex items-center justify-between mb-8">
                    <Link href="/login" className="inline-flex items-center gap-1 text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition">
                        <ArrowLeft size={16} /> Back to login
                    </Link>
                    <div className="text-[var(--gold)]">
                        <Logo className="w-6 h-6" textCls="text-lg text-[var(--text-primary)]" />
                    </div>
                </div>
                    ...
                    <form onSubmit={form1.handleSubmit(onStep1)} className="space-y-4">
                        ...
                        <div className="relative mt-6 mb-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="bg-[var(--bg-primary)] px-2 text-[var(--text-muted)]">Or sign up with</span>
                            </div>
                        </div>
