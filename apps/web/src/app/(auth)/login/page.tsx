                ...
                <div className="w-full max-w-[400px]">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <a
                            ...
                            className="w-full flex items-center justify-center gap-2 py-3 rounded-[var(--radius-md)] bg-[var(--bg-card)] border border-[var(--border)] text-[var(--text-primary)] font-medium hover:bg-[var(--bg-card-hover)] transition disabled:opacity-50 disabled:cursor-not-allowed"
                        >
