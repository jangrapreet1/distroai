...
function LoginForm() {
    const { login, isLoggingIn, handleGoogleCallback } = useAuth();
    ...
    return (
        <div className="flex-1 flex items-center justify-center px-6 py-12">
            <div className="w-full max-w-[400px]">
                <div className="lg:hidden mb-8 text-[var(--gold)]">
                    <Logo className="w-8 h-8" textCls="text-2xl text-[var(--text-primary)]" />
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <a
                        ...
                        className="w-full flex items-center justify-center gap-2 py-3 rounded-[var(--radius-md)] bg-[var(--bg-card)] border border-[var(--border)] text-[var(--text-primary)] font-medium hover:bg-[var(--bg-card-hover)] transition"
                    >
...
export default function LoginPage() {
    return (
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-[var(--bg-secondary)] flex-col justify-center px-16 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="mb-2 text-[var(--gold)]">
                        <Logo className="w-10 h-10" textCls="text-4xl text-[var(--text-primary)]" />
                    </div>
            ...
            <Suspense fallback={<div className="flex-1 flex items-center justify-center"><div className="text-[var(--text-muted)]">Loading...</div></div>}>
                <LoginForm />
            </Suspense>
        </div>
    );
