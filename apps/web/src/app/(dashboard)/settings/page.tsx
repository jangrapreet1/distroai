...
import { Building2, FileText, Bell, Plug, Receipt, Check, Users, UserPlus, X, Shield, MapPin, Truck, CheckCircle2, Download, Globe, Store, Copy, QrCode, ExternalLink } from "lucide-react";
...
const TABS = [
    ...
    { id: "portal", labelKey: "Portal", icon: Store },
        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-center items-center gap-4 mb-4 mt-8">
                ...
                <button
                    ...
                    className="w-12 h-6 rounded-full bg-[var(--purple)] p-1 relative transition-colors focus:outline-none"
                >
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-full bg-[var(--purple)]/15 text-[var(--purple)] blur-0">2 Months Free</span>
                </div>
            </div>
